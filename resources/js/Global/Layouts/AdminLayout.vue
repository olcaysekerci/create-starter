    ...
    <div class="flex h-screen bg-gray-50">
        ...
        <div 
            :class="[
                ...
                isMobile ? 'fixed h-full top-0 left-0' : 'relative'
            ]"
        ...
        >
            ...
            <nav class="flex-1 px-3 py-6 space-y-1 overflow-y-auto">
                ...
                >
                    <svg class="w-5 h-5 text-gray-500 dark:text-gray-400 group-hover:text-gray-700 dark:group-hover:text-gray-300 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                        <path d="M3 4a1 1 0 011-1h12a1 1 0 011 1v2a1 1 0 01-1 1H4a1 1 0 01-1-1V4zM3 10a1 1 0 011-1h6a1 1 0 011 1v6a1 1 0 01-1 1H4a1 1 0 01-1-1v-6zM14 9a1 1 0 00-1 1v6a1 1 0 001 1h2a1 1 0 001-1v-6a1 1 0 00-1-1h-2z"/>
                    </svg>
                    <span v-if="!sidebarCollapsed || isMobile" class="ml-3 truncate">Dashboard</span>
                </Link>
                ...
                >
                    ...
                    <span v-if="!sidebarCollapsed || isMobile" class="ml-3 truncate">Kullanıcılar</span>
                </Link>
                ...
                <Link 
                    ...
                    :class="{ 'justify-center': sidebarCollapsed && !isMobile }"
                >
                    <svg class="w-5 h-5 text-gray-500 dark:text-gray-400 group-hover:text-gray-700 dark:group-hover:text-gray-300 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/>
                    </svg>
                    <span v-if="!sidebarCollapsed || isMobile" class="ml-3 truncate">Aktivite Logları</span>
                </Link>
                ...
                >
                    ...
                    <span v-if="!sidebarCollapsed || isMobile" class="ml-3 truncate">Mail Bildirimleri</span>
                </Link>
                ...
                >
                    ...
                    <span v-if="!sidebarCollapsed || isMobile" class="ml-3 truncate">Ayarlar</span>
                </Link>
            </nav>
        </div>
                ...
                <div class="flex items-center space-x-1 sm:space-x-3">
                    ...
                    <div class="relative" @click.stop>
                        ...
                        <div v-if="showUserMenu" class="absolute right-0 mt-2 w-48 bg-white dark:bg-gray-800 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 z-50">
                            <div v-if="isReady" class="px-4 py-3 border-b border-gray-100 dark:border-gray-700">
                                <p class="text-sm font-medium text-gray-900 dark:text-gray-100 truncate">{{ pageProps.auth.user.name }}</p>
                                <p class="text-xs text-gray-500 dark:text-gray-400 truncate">{{ pageProps.auth.user.email }}</p>
                            </div>
                            <div class="py-1">
